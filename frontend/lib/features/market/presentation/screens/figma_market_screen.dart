...
class FigmaMarketScreen extends StatefulWidget {
  const FigmaMarketScreen({super.key});

  @override
  State<FigmaMarketScreen> createState() => _FigmaMarketScreenState();
}

class _FigmaMarketScreenState extends State<FigmaMarketScreen> {
